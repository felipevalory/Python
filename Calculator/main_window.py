...
from styles import Display
from variables import MEDIUM_FONT_SIZE, SMALL_FONT_SIZE
from utilities import isNumOrDot, isEmpty, isValidNumber, convertToNumber
from PySide6.QtCore import Slot
from PySide6.QtWidgets import (QGridLayout, QLabel, QMainWindow, QPushButton,
...
class Info(QLabel):
    def __init__(
            self, text: str, parent: QWidget | None = None) -> None:
...
class ButtonsGrid(QGridLayout):
    ...
    def vouApagarVocê(self, *args):
        print('Signal recebido por "Vou apagar você" em',
        ...
        for i, row in enumerate(self._gridMask):
            for j, buttonText in enumerate(row):
                ...
                if not isNumOrDot(buttonText) and not isEmpty(buttonText):
                    ...
                    self._settingSpecialButton(button)
    ...
    def _settingSpecialButton(self, button):
        text = button.text()
    ...
    def _configLeftOp(self, text):
        ...
        if not isValidNumber(displayText) and self._left is None:
            self._showError('You did not input anything')
            return
    ...
    def _eq(self):
        ...
        try:
            ...
            self._showError('Number too big')
